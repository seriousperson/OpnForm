    ...
    redirectIfSubscribed () {
      if (this.user.is_subscribed) {
        ...
        if (this.user.has_enterprise_subscription) {
          useAlert().success('Awesome! Your subscription to FormBuilder is now confirmed! You now have access to all Enterprise ' +
            'features. No need to invite your teammates, just ask them to create a FormBuilder account and to connect the same Notion workspace. Feel free to contact us if you have any question 🙌')
        } else {
          useAlert().success('Awesome! Your subscription to FormBuilder is now confirmed! You now have access to all Pro ' +
